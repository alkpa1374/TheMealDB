    ...
    public void handle(MouseEvent event) 
    {
    	...
    	if (event.getSource() == getMealByNameBtn) 
    	{
    	    ...
    	    try 
    	    {
    	        ...
    	        //Get the table view's current items
    	        List<MealInfo> items = MealTableView.getItems();
    	        
    	        //Clearance of the table view before Addition new results
    	        items.clear();
    	        
    	        //Addition of all meals returned by the REST API to the table view
    	...
    	else if (event.getSource() == addFavouriteBtn) 
    	{
    	    try
    	    {
    	        ...
    	        //Get the currently selected MealInfo items from the table view
    	        ObservableList<MealInfo> selectedItems = selectionModel.getSelectedItems();
    	        
    	        //Iterate over all items in the table view
