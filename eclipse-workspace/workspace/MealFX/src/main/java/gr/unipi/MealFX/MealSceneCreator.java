...
public class MealSceneCreator implements EventHandler<MouseEvent>
{
     ...
     //Create a TableColumn for the first ingredient (strIngredient1) of MealInfo
      ...
      //Create a TableColumn for the 'strSource' property of MealInfo
        ...
        //Add the "Get Random Meal" button to the FlowPane
        buttonFlowPane.getChildren().add(getRandomMealBtn);

        //Add the "Add Favourite" button to the FlowPane
        buttonFlowPane.getChildren().add(addFavouriteBtn);

        //Add the "Add Cooked" button to the FlowPane
        buttonFlowPane.getChildren().add(addCookedBtn);

        //Add the "Get Details" button to the FlowPane
        buttonFlowPane.getChildren().add(getDetailsBtn);

        //Set horizontal gap of 10 pixels between buttons in the FlowPane
        buttonFlowPane.setHgap(10);

        //Align all buttons in the center of the FlowPane
        ...
        //Set vertical gap between rows in the inputFieldsPane to 10 pixels
        inputFieldsPane.setVgap(10);

        //Set horizontal gap between columns in the inputFieldsPane to 10 pixels
        inputFieldsPane.setHgap(10);

        //Align all components in the center of the inputFieldsPane
        inputFieldsPane.setAlignment(Pos.CENTER);

        //Add the inputFieldsPane to the rootGridPane at column 0, row 0
        rootGridPane.add(inputFieldsPane, 0, 0);

        //Add the TableView to the rootGridPane at column 0, row 1
        rootGridPane.add(MealTableView, 0, 1);

        //Add the FlowPane with buttons to the rootGridPane at column 0, row 2
        rootGridPane.add(buttonFlowPane, 0, 2);

        //Add the back button to the rootGridPane at column 0, row 3
        rootGridPane.add(backBtn, 0, 3);

        //Set horizontal gap between columns in the rootGridPane to 10 pixels
        rootGridPane.setHgap(10);

        //Set vertical gap between rows in the rootGridPane to 10 pixels
        rootGridPane.setVgap(10);

        //Attach this class as the mouse click event handler for the "Get Meal By Name" button
        getMealByNameBtn.setOnMouseClicked(this);

        //Attach this class as the mouse click event handler for the "Get Specific Meal" button
        getSpecificMealBtn.setOnMouseClicked(this);

        //Attach this class as the mouse click event handler for the "Get Random Meal" button
        getRandomMealBtn.setOnMouseClicked(this);

        //Attach this class as the mouse click event handler for the "Add Favourite" button
        addFavouriteBtn.setOnMouseClicked(this);

        //Attach this class as the mouse click event handler for the "Add Cooked" button
        addCookedBtn.setOnMouseClicked(this);

        //Attach this class as the mouse click event handler for the "Get Details" button
        getDetailsBtn.setOnMouseClicked(this);

        //Attach this class as the mouse click event handler for the "Back" button
        backBtn.setOnMouseClicked(this);

        //Create a File object representing "favourite.json"
        File favourite = new File("favourite.json");

        //Create a File object representing "cooked.json"
