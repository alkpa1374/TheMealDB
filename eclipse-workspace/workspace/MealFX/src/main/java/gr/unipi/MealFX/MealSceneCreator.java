//Class "MealSceneCreator" belongs to package "gr.unipi.MealFX"
...
public class MealSceneCreator implements EventHandler<MouseEvent>
{
     ...
     //Creation of a new list storing the cooked meals
	 ...
	 public MealSceneCreator() 
	 {
        ...
        //Creation of a File object representation of "favourite.json"
        File favourite = new File("favourite.json");

        //Creation of a File object representation of "cooked.json"
    ...
    {
    	//Checking of the "Get Meal By Name" button as the event source
    	if (event.getSource() == getMealByNameBtn) 
    	{
    	    //Creation of a new instance of the MealAPIService based on the REST API of THEMEALDB URL
    	    MealAPIService mas = new MealAPIService("https://www.themealdb.com");
    	    
    	    try 
    	    {
    	        //Getting of the text entered by the user in the input field
    	        String name = paramField.getText();
    	        
    	        //Calling of the API service to get a list of meals by name/main ingredient
    	    ...
    	    {
    	        //Presentation of custom pop-up window notifying the user no meal was found
    	...
    	//Checking of the "Get Specific Meal" button as event source
    	...
    	//Checking of the "Get Random Meal" button as the event source
    	...
    	//Checking of the "Add Favourite" button as the event source
    	else if (event.getSource() == addFavouriteBtn) 
    	{
    	    try
    	    {
    	        ...
    	        for (MealInfo MI : MealTableView.getItems())
    	        {
    	            ...
    	            {
    	                //Checking if selected meal is not already in favourite list
    	                if (!FavMealList.contains(MI))
    	                {
    	                    //Addition of the meal to favourite meals list
    	                    FavMealList.add(MI);
    	                    
    	                    //Presentation of custom pop-up window notifying the user the meal has been successfully added to favourite meals list
    	                    MealPopUp mealPopUp = new MealPopUp(
    	...
    	//Checking of the "Add Cooked" button as the event source
    	else if (event.getSource() == addCookedBtn) 
    	{
    	    try
    	    {
    	        ...
    	        for (MealInfo MI : MealTableView.getItems())
    	        {
    	            ...
    	            if (selectedItems.contains(MI))
    	            {
    	                //Checking if selected meal is not already in cooked list
    	                if (!CoMealList.contains(MI))
    	                {
    	                    //Addition of the meal to cooked meals list
    	                    CoMealList.add(MI);
    	                    
    	                    //Presentation of custom pop-up window notifying the user the meal has been successfully added to cooked meals list
    	                    MealPopUp mealPopUp = new MealPopUp(
    	                ...
    	                {
    	                    //Presentation of custom pop-up window notifying the user the meal is already on cooked meals list
    	                    MealPopUp mealPopUp = new MealPopUp(
