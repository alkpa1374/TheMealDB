//Class "MealAPISrviceTest" belongs to package "testing"
package testing;
...
public class MealAPIServiceTest 
{
    ...
    public void testSearchMealByName() throws MealAPIException 
    {
        ...
        //Calling of the REST API of THEMEALDB to search meals by the name "Arrabiata" and results storing
        final List<MealInfo> results = mealSearchService.getMealByNameOrIngredient("Arrabiata");
        //Assertion of not empty results list
        Assert.assertFalse(results.isEmpty());
        //Repetition of all meals in the results
        for (MealInfo meal : results) 
        {
            //Printing of meal ID, name and image to the console
            System.out.println
            (
    ...
    public void testSearchMealByIngredient() throws MealAPIException 
    {
        //Creation of a new MealAPIService instance with the base API URL
        final MealAPIService mealSearchService = new MealAPIService("https://www.themealdb.com/"); 
        //Calling of the REST API of THEMEALDB to search meals by the main ingredient "pasta" and results storing
    ...
    public void testSearchMealByID() throws MealAPIException 
    {
        //Creation of a new MealAPIService instance with the base API URL
        final MealAPIService mealSearchService = new MealAPIService("https://www.themealdb.com/"); 
        //Calling of the REST API of THEMEALDB to search meal by ID "52772" and results storing
    ...
    public void testSearchMealRandom() throws MealAPIException 
    {
        //Creation of a new MealAPIService instance with the base API URL
        final MealAPIService mealSearchService = new MealAPIService("https://www.themealdb.com/"); 
        //Calling of the REST API of THEMEALDB to search random meal and result storing
